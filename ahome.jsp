    ...
    <div id="page-contents">
    	<div class="container">
            ...
            <div class="profile-card">
            	...
            	<img src="images/users/user-10.jpg" alt="user" class="profile-photo" />
            	<h5><a href="timeline.html" class="text-white">Admin</a></h5>
...
String name1="",caption="",ii="",status="";
 int i=0;
while(rs.next())
{
...
%>
            ...
            <div class="post-content">
              ...
              <div class="post-container">
                <img src="images/users/user-10.jpg" alt="user" class="profile-photo-md pull-left" />
                <div class="post-detail">
                  ...
                  <div class="post-text">
                      <p><%=caption%></p>
                   <p><%=status%></p>
                   <h5>  <a href="approvel.jsp?id=<%=ii%>&&status=approved">approve</a></h5>
                   <h5>    <a href="approvel.jsp?id=<%=ii%>&&status=cancel">cancel</a> </h5>
                  </div>
                  <div class="line-divider"></div>
      ...
      iii=rss.getString("id");
          ...
          %>
              ...
              <div class="follow-user">
                ...
                <div>
                    <h5><a href="timeline.html"><%=uname%></a></h5><br>
                </div>
              </div>
               <%
} 
