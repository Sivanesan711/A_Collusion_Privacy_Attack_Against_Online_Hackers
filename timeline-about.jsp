...
Class.forName("com.mysql.jdbc.Driver");
 ...
 PreparedStatement pst = conn.prepareStatement("Select * from registration where id='"+ id +"'");
ResultSet rs=pst.executeQuery();
String name="",mail="",phone="",age="",city="", ii="";
 int i=0;
while(rs.next())
{
     name=rs.getString("name");  mail=rs.getString("mail");  phone=rs.getString("phone");  age=rs.getString("age");
      city=rs.getString("city");   ii=rs.getString("id");
}
%>
    <!-- Header
    ================================================= -->
            ...
            <div class="row">
              <div class="col-md-3">
                <div class="profile-info">
                  <img src="images.jsp?id=<%=id%>"  alt="" class="img-responsive profile-photo" />
                  <h3><%= name %></h3>
